...
For getting better results enter a whole number bigger than 2.""")
    ...
    def test_values_until(self):
        self.assertRaises(
            ValueError, fibonacci_sequence.fibonacci_values_untill, 'abc')
        self.assertRaises(
            ValueError, fibonacci_sequence.fibonacci_values_untill, -1)
        self.assertEqual(fibonacci_sequence.fibonacci_values_untill(24), [
                         0, 1, 1, 2, 3, 5, 8, 13, 21])
        self.assertEqual(fibonacci_sequence.fibonacci_values_untill(24.5), [
                         0, 1, 1, 2, 3, 5, 8, 13, 21])
        self.assertEqual(fibonacci_sequence.fibonacci_values_untill(0), """[0, 1]
For getting better results enter a number bigger than 1.""")
        self.assertEqual(fibonacci_sequence.fibonacci_values_untill(0.5), """[0, 1]
For getting better results enter a number bigger than 1.""")
        self.assertEqual(fibonacci_sequence.fibonacci_values_untill(1), """[0, 1]
For getting better results enter a number bigger than 1.""")
