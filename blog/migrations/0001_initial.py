    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_1', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_1', models.TextField(blank=True, default=None)),
                ('image_2', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_2', models.TextField(blank=True, default=None)),
                ('image_3', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_3', models.TextField(blank=True, default=None)),
                ('image_4', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_4', models.TextField(blank=True, default=None)),
                ('image_5', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_5', models.TextField(blank=True, default=None)),
                ('image_6', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_6', models.TextField(blank=True, default=None)),
                ('image_7', models.ImageField(blank=True, default=None, upload_to='article-images/')),
                ('paragraph_7', models.TextField(blank=True, default=None)),
                ('image_8', models.ImageField(blank=True, default=None, upload_to='article-images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('replied_to', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='blog.comment')),
            ],
            options={
                'abstract': False,
            },
